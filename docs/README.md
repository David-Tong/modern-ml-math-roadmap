...
[分析与机器学习](02-analysis-for-machine-learning/) 组织实变函数、测度论、最优化理论和变分法、泛函分析、常微分方程、偏微分方程、动力系统与自动控制原理相关内容。凸分析作为凸优化的重要语言，已经并入“最优化理论和变分法”。
...
- [常微分方程](02-analysis-for-machine-learning/04-ordinary-differential-equations/)：学习 ODE 的基本解法、非线性近似、数值方法、特殊函数和解的基本理论。
- [偏微分方程](02-analysis-for-machine-learning/05-partial-differential-equations/)：学习 PDE 的经典类型、求解方法和数学物理概念，连接扩散模型、神经算子和 PINN。
- [动力系统与自动控制原理](02-analysis-for-machine-learning/06-dynamical-systems-and-control/)：理解状态演化、稳定性、梯度流、信号与系统、傅里叶与拉普拉斯变换、反馈和最优控制，连接神经 ODE、连续优化和强化学习。
